 ...
 **Important:** _The OPPAlipayPaymentParams class is formally deprecated in 1.4.0. To make Alipay transaction, instead use OPPPaymentParams class with payment brand 'ALIPAY'._
 */
