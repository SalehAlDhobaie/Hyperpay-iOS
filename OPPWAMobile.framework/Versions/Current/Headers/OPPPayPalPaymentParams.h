 ...
 **Important:** _The OPPPayPalPaymentParams class is formally deprecated in 1.4.0. To make PayPal transaction, instead use OPPPaymentParams class with payment brand 'PAYPAL'._
 */
