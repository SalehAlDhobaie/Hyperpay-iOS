...
/**
 Creates an OPPCard object with provided values.
 ...
 */
+ (nullable instancetype)cardWithHolder:(NSString *)holder last4Digits:(NSString *)last4Digits expiryMonth:(NSString *)expiryMonth expiryYear:(NSString *)expiryYear;
...
/**
 ...
 @return Returns an OPPCard object, or nil if parameters are empty.
 */
- (nullable instancetype)initWithHolder:(NSString *)holder last4Digits:(NSString *)last4Digits expiryMonth:(NSString *)expiryMonth expiryYear:(NSString *)expiryYear NS_DESIGNATED_INITIALIZER;
